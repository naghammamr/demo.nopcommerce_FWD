@smoke
  Feature: F06_HomePageSliders
    ...
    Scenario: Verify that the first slider is clickable and navigate to the correct URL
      Given the user clicks on the first slider on the home page
      Then user will be redirected to the nokia Lumia product page

    Scenario: Verify that the second slider is clickable and navigate to the correct URL
